        ...
        if (slot.value && !loading.value && !error.value) {
            ...
            useHead({
                ...
                meta: [
                    ...
                    { name: 'googlebot', content: generateRobotsContent(slot.value) },
                    { name: 'bingbot', content: generateRobotsContent(slot.value) },
                    { name: 'yandex', content: generateRobotsContent(slot.value) },
