<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex items-center text-sm text-gray-500">
            ...
            <span class="mx-2">/</span>
            <span class="text-gray-800 font-medium" v-if="slot">{{ slot.name || 'Слот' }}</span>
          </div>
        </div>
      </div>
    </nav>
    ...
    <div v-else-if="slot" class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-blue-900 shadow-2xl mb-8">
        <!-- Анимированный фон -->
            ...
            <div class="aspect-video bg-gradient-to-br from-black/40 via-purple-900/30 to-black/40 rounded-2xl backdrop-blur-md border border-white/20 shadow-2xl flex items-center justify-center mb-8 relative overflow-hidden group">
              ...
              <div class="text-center relative z-10">
                ...
                <div class="bg-black/30 backdrop-blur-sm rounded-2xl px-6 py-4 border border-white/20">
                  <p class="text-white/90 text-lg font-bold mb-2">{{ slot.name || 'Загрузка...' }}</p>
  ...
  <div class="container mx-auto px-4 py-8">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
        <div class="flex items-center gap-3 mb-8">
          ...
          <h2 class="text-4xl font-bold text-gray-800">{{ slot.name || 'Слот' }} - Полный обзор слота 2025</h2>
        </div>

        <!-- Основное описание -->
        <div class="prose max-w-none mb-8">
          <p class="text-xl text-gray-700 leading-relaxed mb-6 font-medium">
            Gates of Olympus — это мощный слот от Pragmatic Play, черпающий энергию из бесконечной силы Зевса, короля богов. В мире древнегреческой мифологии существуют десятки онлайн-слотов, но суперзвездой в этой тематической категории является именно Gates of Olympus, разделяющий топовую позицию со своим собратом Gates of Olympus 1,000.
          </p>
          
          <p class="text-lg text-gray-700 leading-relaxed mb-8">
            Это слот с высокой волатильностью и системой scatter pays, где выигрыши начисляются за одинаковые символы независимо от их положения на сетке. Популярная механика в сочетании с неограниченными каскадами и множителями — вот ключевые особенности, обеспечивающие успех данного тайтла. Когда игроки входят в бесплатные спины, события могут стать по-настоящему дикими благодаря Total Multiplier, который не сбрасывается между раундами.
          </p>

          <div class="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl border-l-4 border-amber-400 mb-8">
            <h3 class="font-bold text-amber-800 mb-4 text-xl">⚡ Ключевые характеристики слота:</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <ul class="text-amber-700 space-y-2">
                <li class="flex items-center gap-2"><span class="w-2 h-2 bg-amber-500 rounded-full"></span>Механика Tumble с каскадными выигрышами</li>
                <li class="flex items-center gap-2"><span class="w-2 h-2 bg-amber-500 rounded-full"></span>Случайные множители от x2 до x500</li>
                <li class="flex items-center gap-2"><span class="w-2 h-2 bg-amber-500 rounded-full"></span>15 бесплатных спинов в бонусной игре</li>
              </ul>
              <ul class="text-amber-700 space-y-2">
                <li class="flex items-center gap-2"><span class="w-2 h-2 bg-amber-500 rounded-full"></span>Возможность купить бонус за 100x ставки</li>
                <li class="flex items-center gap-2"><span class="w-2 h-2 bg-amber-500 rounded-full"></span>Максимальный выигрыш 5,000x от ставки</li>
                <li class="flex items-center gap-2"><span class="w-2 h-2 bg-amber-500 rounded-full"></span>Один крупный выигрыш на 697,350 спинов</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          ...
          <details class="group border-2 border-gradient-to-r from-blue-400 to-purple-500 rounded-2xl overflow-hidden hover:shadow-2xl transition-all duration-300 bg-gradient-to-br from-white to-blue-50">
            <summary class="p-8 cursor-pointer font-bold text-2xl hover:bg-gradient-to-r hover:from-blue-100 hover:to-purple-100 transition-all duration-300 flex items-center justify-between border-b border-blue-200">
              ...
              <svg class="w-6 h-6 text-blue-600 group-open:rotate-180 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="p-8 bg-gradient-to-br from-slate-50 to-blue-50">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                <!-- Общий рейтинг -->
                <div class="bg-gradient-to-br from-blue-500 to-blue-700 p-6 rounded-xl text-white transform hover:scale-105 transition-all duration-300 shadow-lg">
                  ...
                  <p class="text-blue-100 text-sm">Входит в ТОП-3 самых популярных слотов мира уже 3 года подряд</p>
                </div>

                <!-- Количество игроков -->
                <div class="bg-gradient-to-br from-green-500 to-green-700 p-6 rounded-xl text-white transform hover:scale-105 transition-all duration-300 shadow-lg">
                  <div class="flex items-center justify-between mb-4">
                    <div class="bg-white/20 p-3 rounded-lg">
                      <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <p class="text-green-100 text-sm">Ежемесячно играют более 2.4 млн уникальных игроков</p>
                </div>

                <!-- RTP и волатильность -->
                <div class="bg-gradient-to-br from-purple-500 to-purple-700 p-6 rounded-xl text-white transform hover:scale-105 transition-all duration-300 shadow-lg">
                  <div class="flex items-center justify-between mb-4">
                    <div class="bg-white/20 p-3 rounded-lg">
                      <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <p class="text-purple-100 text-sm">Высокая отдача и захватывающие колебания выигрышей</p>
                </div>
              </div>

              <!-- Статистика популярности -->
              <div class="bg-white p-6 rounded-xl shadow-lg border-2 border-blue-100 mb-6">
                ...
                <div class="space-y-4">
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 bg-gray-200 rounded-full h-4 relative overflow-hidden">
                      <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 h-full rounded-full shadow-inner" style="width: 100%;">
                    ...
                    <div class="text-sm text-gray-600 w-32">Лучший новый слот</div>
                  </div>
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 bg-gray-200 rounded-full h-4 relative overflow-hidden">
                      <div class="bg-gradient-to-r from-green-400 to-green-600 h-full rounded-full shadow-inner" style="width: 95%;">
                        <div class="absolute inset-0 bg-white/20 animate-pulse"></div>
                      </div>
                    </div>
                    <div class="w-16 text-right">
                      <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-bold">#1</span>
                    </div>
                    <div class="text-sm text-gray-600 w-32">Самый популярный</div>
                  </div>
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 bg-gray-200 rounded-full h-4 relative overflow-hidden">
                      <div class="bg-gradient-to-r from-blue-400 to-blue-600 h-full rounded-full shadow-inner" style="width: 90%;">
                        <div class="absolute inset-0 bg-white/20 animate-pulse"></div>
                      </div>
                    </div>
                    <div class="w-16 text-right">
                      <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-bold">#1</span>
                    </div>
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <div class="flex-1 bg-gray-200 rounded-full h-4 relative overflow-hidden">
                      <div class="bg-gradient-to-r from-purple-400 to-purple-600 h-full rounded-full shadow-inner" style="width: 70%;">
                        <div class="absolute inset-0 bg-white/20 animate-pulse"></div>
                      </div>
                    </div>
                    <div class="w-16 text-right">
                      <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-bold">#12</span>
                    </div>
              ...
              <!-- Мини-график тренда -->
              <div class="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-xl border-2 border-indigo-200 mb-6">
                <h4 class="font-bold text-indigo-800 mb-4 text-xl flex items-center gap-3">
                  <span class="text-2xl">📊</span>
                  Тренд популярности (симулированный график)
                </h4>
                
                <div class="relative h-32 bg-white rounded-lg p-4 border border-indigo-100">
              ...
              <div class="bg-white p-6 rounded-xl shadow-lg border-2 border-green-100">
                <h4 class="font-bold text-green-800 mb-4 text-xl flex items-center gap-3">
                  <span class="text-2xl">✨</span>
          ...
          <details class="group border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-all duration-300">
            <summary class="p-6 cursor-pointer font-semibold text-xl hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 transition-all duration-300 flex items-center justify-between">
              ...
              <div class="prose max-w-none">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div class="bg-white p-4 rounded-lg border border-green-200">
                    <h4 class="font-bold text-green-800 mb-3">🍭 Связь с Sweet Bonanza</h4>
                    <p class="text-gray-700 text-sm">
                  ...
                  <div class="bg-white p-4 rounded-lg border border-green-200">
                    <h4 class="font-bold text-green-800 mb-3">⚖️ Идеальный баланс</h4>
                    <p class="text-gray-700 text-sm">
          ...
          <!-- Особенности слота -->
          <details class="group border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-all duration-300">
            <summary class="p-6 cursor-pointer font-semibold text-xl hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 flex items-center justify-between">
              <span class="flex items-center gap-3">
                <span class="text-2xl">🎰</span>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                  ...
                  <div class="bg-white p-5 rounded-lg border border-purple-200">
                    <div class="flex items-center gap-3 mb-3">
                      ...
                      <h4 class="font-bold text-purple-800">Tumbles (Каскады)</h4>
                    </div>
                    <p class="text-gray-700 text-sm mb-3">
                    ...
                    <p class="text-purple-700 font-medium text-sm">
                      Обычно 1-2 каскада подряд, но иногда цепочка может продолжаться очень долго!
                    </p>
                  </div>
                  ...
                  <div class="bg-white p-5 rounded-lg border border-purple-200">
                    ...
                    <p class="text-gray-700 text-sm mb-3">
                      Четыре орба разных цветов (зеленый, синий, фиолетовый и красный) могут умножить ваши выплаты до 500x. Каждый символ множителя принимает случайное значение.
                    </p>
                    <p class="text-purple-700 font-medium text-sm">
                      Множители применяются к общему выигрышу раунда после всех каскадов!
                    </p>
                  </div>
                </div>
          ...
          <!-- Бесплатные спины -->
          <details class="group border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-all duration-300">
            <summary class="p-6 cursor-pointer font-semibold text-xl hover:bg-gradient-to-r hover:from-orange-50 hover:to-red-50 transition-all duration-300 flex items-center justify-between">
              <span class="flex items-center gap-3">
                <span class="text-2xl">⚡</span>
                  ...
                  <div class="bg-white p-5 rounded-lg border border-orange-200">
                    ...
                    <div class="space-y-2">
                      <div class="flex justify-between items-center p-2 bg-orange-50 rounded">
                        ...
                        <span class="font-bold text-orange-600">x3 от ставки</span>
                      </div>
                      <div class="flex justify-between items-center p-2 bg-orange-50 rounded">
                        <span class="font-medium">5 символов Зевса:</span>
                        <span class="font-bold text-orange-600">x5 от ставки</span>
                      </div>
                      <div class="flex justify-between items-center p-2 bg-orange-100 rounded">
                        <span class="font-medium">6 символов Зевса:</span>
                        <span class="font-bold text-orange-700">x100 от ставки</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bg-white p-5 rounded-lg border border-orange-200">
                    ...
                    <ul class="space-y-2 text-gray-700">
                      <li class="flex items-start gap-2">
                        ...
                        <span>15 бесплатных спинов независимо от количества scatter-символов</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Total Multiplier не сбрасывается между раундами</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></span>
                        <span>Возможность получить дополнительные бесплатные спины</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></span>
          ...
          <!-- Стратегии игры -->
          <details class="group border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-all duration-300">
            <summary class="p-6 cursor-pointer font-semibold text-xl hover:bg-gradient-to-r hover:from-indigo-50 hover:to-blue-50 transition-all duration-300 flex items-center justify-between">
              <span class="flex items-center gap-3">
                <span class="text-2xl">🎯</span>
            ...
            <div class="p-6 border-t border-gray-200 bg-gradient-to-r from-indigo-50 to-blue-50">
              <div class="prose max-w-none">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div class="bg-white p-5 rounded-lg border border-indigo-200">
                    ...
                    <ul class="space-y-3 text-gray-700">
                      <li class="flex items-start gap-2">
                        <span class="w-5 h-5 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div class="bg-white p-5 rounded-lg border border-indigo-200">
                    ...
                    <ul class="space-y-3 text-gray-700">
                      <li class="flex items-start gap-2">
                        <span class="w-5 h-5 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span class="text-white text-xs font-bold">💰</span>
                        </span>
                        <span>Управление банкроллом: не более 1-2% от банка на спин</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="w-5 h-5 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span class="text-white text-xs font-bold">🎲</span>
                        </span>
                        <span>Ante Bet увеличивает шансы на бонус, но требует больших ставок</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="w-5 h-5 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span class="text-white text-xs font-bold">🛒</span>
                        </span>
                        <span>Покупка бонуса оправдана только при достаточном банке</span>
                      </li>
                      <li class="flex items-start gap-2">
                        <span class="w-5 h-5 bg-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                          <span class="text-white text-xs font-bold">📊</span>
                        </span>
                        <span>Ведите статистику сессий для анализа результатов</span>
                      </li>
                    </ul>
                  </div>
                </div>

                <div class="bg-white p-5 rounded-lg border border-indigo-200 mt-6">
                  <h4 class="font-bold text-indigo-800 mb-4 flex items-center gap-2">
                    ⚠️ Важные предупреждения
                  </h4>
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="bg-red-50 p-4 rounded-lg border-l-4 border-red-400">
                      <h5 class="font-bold text-red-800 mb-2">Высокая волатильность</h5>
                      <p class="text-red-700 text-sm">Длительные периоды без крупных выигрышей — это нормально. Будьте готовы к затяжным потерям.</p>
                    </div>
                    <div class="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-400">
                      <h5 class="font-bold text-yellow-800 mb-2">Покупка бонуса</h5>
                      <p class="text-yellow-700 text-sm">100x ставка за бонус не гарантирует прибыль. Используйте эту функцию разумно.</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <!-- Статистика популярности -->
      <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Насколько популярен {{ slot.name || 'этот слот' }}?</h2>
        ...
        <div class="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p class="text-yellow-800 font-medium">
            🏆 {{ slot.name || 'Этот слот' }} удерживает топовые позиции в рейтингах уже несколько лет подряд, что подтверждает его исключительное качество и увлекательность геймплея.
          </p>
        </div>
      </div>
      ...
      <div class="relative overflow-hidden bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 rounded-3xl shadow-2xl backdrop-blur-sm border border-white/20 p-4 sm:p-6 lg:p-10 mb-8">
        ...
        <div class="relative z-10 flex flex-col sm:flex-row items-center gap-4 mb-8 text-center sm:text-left">
          ...
          <div>
            ...
            <p class="text-lg text-gray-600 font-medium">{{ slot.name || 'Слот' }}</p>
          </div>
        </div>
      ...
      <!-- Особенности игры -->
      <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Особенности {{ slot.name || 'слота' }}</h2>
      ...
      <!-- Бонусные функции -->
      <div class="relative bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 rounded-3xl shadow-2xl p-10 mb-8 border border-purple-100/50 overflow-hidden">
        <!-- Фоновые эффекты -->
        <div class="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20viewBox%3D%220%200%2060%2060%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cg%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%3E%3Cg%20fill%3D%22%239333ea%22%20fill-opacity%3D%220.05%22%3E%3Ccircle%20cx%3D%2230%22%20cy%3D%2230%22%20r%3D%224%22/%3E%3C/g%3E%3C/svg%3E')] opacity-60"></div>
        <div class="absolute top-0 right-0 w-96 h-96 bg-purple-400/10 rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute bottom-0 left-0 w-80 h-80 bg-pink-400/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 2s"></div>
        <div class="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 rounded-t-3xl">
        ...
        <div class="relative z-10">
          ...
          <div class="flex items-center gap-4 mb-8">
            <div class="relative">
              <div class="w-16 h-16 bg-gradient-to-br from-purple-500 via-pink-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-xl transform rotate-3 animate-pulse">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path>
                </svg>
              </div>
              <div class="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center animate-bounce">
                <span class="text-white text-xs font-bold">🎁</span>
              </div>
            </div>
            <div>
              <h2 class="text-4xl font-bold bg-gradient-to-r from-gray-900 via-purple-700 to-pink-700 bg-clip-text text-transparent">
                Бонусные функции
              </h2>
              <div class="h-1 w-28 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full mt-2"></div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
            <!-- Бесплатные спины -->
            <div class="group bg-gradient-to-br from-white/80 via-purple-50/50 to-pink-50/50 backdrop-blur-sm p-8 rounded-3xl border border-purple-200/50 shadow-xl hover:shadow-purple-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
              ...
              <div class="relative z-10">
                <div class="flex items-center gap-4 mb-6">
                  <div class="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <span class="text-3xl animate-spin" style="animation-duration: 3s;">🎰</span>
                  </div>
                  <div>
                    <h3 class="text-2xl font-bold text-gray-900 group-hover:text-purple-700 transition-colors duration-300">Бесплатные спины</h3>
                    <div class="text-purple-600 text-sm font-medium">Самый популярный бонус</div>
                  </div>
                </div>
                <p class="text-gray-700 mb-6 text-lg leading-relaxed">Получите 15 бесплатных спинов при выпадении 4 или более scatter-символов Зевса с невероятными множителями.</p>
                <div class="space-y-4">
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    ...
                    <span class="text-purple-700 font-semibold">Увеличенные множители до x500</span>
                  </div>
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full animate-pulse" style="animation-delay: 0.5s"></div>
                    <span class="text-purple-700 font-semibold">Возможность повторного запуска</span>
                  </div>
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full animate-pulse" style="animation-delay: 1s"></div>
                    <span class="text-purple-700 font-semibold">Дополнительные wild-символы</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!-- Множители -->
            <div class="group bg-gradient-to-br from-white/80 via-blue-50/50 to-indigo-50/50 backdrop-blur-sm p-8 rounded-3xl border border-blue-200/50 shadow-xl hover:shadow-blue-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
              <div class="absolute inset-0 bg-gradient-to-br from-blue-400/5 to-indigo-400/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div class="relative z-10">
                <div class="flex items-center gap-4 mb-6">
                  <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-700 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                    <span class="text-3xl animate-bounce">⚡</span>
                  </div>
                  <div>
                    <h3 class="text-2xl font-bold text-gray-900 group-hover:text-blue-700 transition-colors duration-300">Множители</h3>
                    <div class="text-blue-600 text-sm font-medium">Случайные усиления</div>
                  </div>
                </div>
                <p class="text-gray-700 mb-6 text-lg leading-relaxed">Случайные множители могут появляться в любой момент игры, значительно увеличивая ваши выигрыши.</p>
                <div class="space-y-4">
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full animate-pulse"></div>
                    <span class="text-blue-700 font-semibold">От x2 до x500</span>
                  </div>
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full animate-pulse" style="animation-delay: 0.5s"></div>
                    <span class="text-blue-700 font-semibold">Применяются к общему выигрышу</span>
                  </div>
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full animate-pulse" style="animation-delay: 1s"></div>
                    <span class="text-blue-700 font-semibold">Могут складываться между собой</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <!-- Покупка бонуса -->
            <div class="group bg-gradient-to-br from-white/80 via-amber-50/50 to-orange-50/50 backdrop-blur-sm p-8 rounded-3xl border border-amber-200/50 shadow-xl hover:shadow-amber-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
              ...
              <div class="relative z-10">
                <div class="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <h3 class="text-2xl font-bold text-gray-900 group-hover:text-amber-700 transition-colors duration-300">Покупка бонуса</h3>
                    <div class="text-amber-600 text-sm font-medium">Мгновенный доступ</div>
                  </div>
                </div>
                <p class="text-gray-700 mb-6 text-lg leading-relaxed">Не хотите ждать? Купите бонусную игру прямо сейчас за 100x от текущей ставки.</p>
                <div class="space-y-4">
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full animate-pulse"></div>
                    <span class="text-amber-700 font-semibold">Гарантированные 15 фриспинов</span>
                  </div>
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full animate-pulse" style="animation-delay: 0.5s"></div>
                    <span class="text-amber-700 font-semibold">Повышенные шансы на крупный выигрыш</span>
                  </div>
                  <div class="flex items-center gap-3 bg-white/60 p-3 rounded-xl">
                    <div class="w-3 h-3 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full animate-pulse" style="animation-delay: 1s"></div>
                    <span class="text-amber-700 font-semibold">Доступно в любой момент</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="relative bg-gradient-to-br from-white/90 via-emerald-50/60 to-green-50/60 backdrop-blur-sm p-8 rounded-3xl border border-emerald-200/60 shadow-xl overflow-hidden">
            <div class="absolute inset-0 bg-gradient-to-r from-emerald-400/5 to-green-400/5"></div>
            <div class="relative z-10">
              <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 class="text-2xl font-bold text-gray-900">Механика Tumble</h3>
                  <div class="text-emerald-600 font-medium">Каскадные выигрыши</div>
                </div>
              </div>
              <p class="text-gray-700 mb-8 text-lg leading-relaxed">После каждого выигрыша выигрышные символы исчезают, а новые символы падают сверху, создавая возможности для цепочек выигрышей без дополнительных ставок.</p>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="text-center group">
                  <div class="relative">
                    <div class="w-20 h-20 bg-gradient-to-br from-emerald-100 to-green-200 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <span class="text-3xl animate-pulse">1️⃣</span>
                    </div>
                    <div class="absolute -top-2 -right-2 w-6 h-6 bg-emerald-500 rounded-full animate-ping opacity-75"></div>
                  </div>
                  <div class="bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-emerald-200/50">
                    <p class="text-emerald-700 font-semibold">Выигрышные символы исчезают</p>
                  </div>
                </div>
                <div class="text-center group">
                  <div class="relative">
                    <div class="w-20 h-20 bg-gradient-to-br from-emerald-100 to-green-200 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <span class="text-3xl animate-bounce" style="animation-delay: 0.3s;">2️⃣</span>
                    </div>
                    <div class="absolute -top-2 -right-2 w-6 h-6 bg-emerald-500 rounded-full animate-ping opacity-75" style="animation-delay: 0.5s;"></div>
                  </div>
                  <div class="bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-emerald-200/50">
                    <p class="text-emerald-700 font-semibold">Новые символы падают вниз</p>
                  </div>
                </div>
                <div class="text-center group">
                  <div class="relative">
                    <div class="w-20 h-20 bg-gradient-to-br from-emerald-100 to-green-200 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                      <span class="text-3xl animate-spin" style="animation-duration: 4s; animation-delay: 0.6s;">3️⃣</span>
                    </div>
                    <div class="absolute -top-2 -right-2 w-6 h-6 bg-emerald-500 rounded-full animate-ping opacity-75" style="animation-delay: 1s;"></div>
                  </div>
                  <div class="bg-white/70 backdrop-blur-sm p-4 rounded-xl border border-emerald-200/50">
                    <p class="text-emerald-700 font-semibold">Процесс повторяется</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <!-- Таблица выплат -->
      <div class="relative bg-gradient-to-br from-white via-emerald-50/20 to-teal-50/30 rounded-3xl shadow-2xl p-10 mb-8 border border-emerald-100/50 overflow-hidden">
        <!-- Фоновая анимация -->
        <div class="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20viewBox%3D%220%200%2060%2060%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Cg%20fill%3D%22none%22%20fill-rule%3D%22evenodd%22%3E%3Cg%20fill%3D%22%2310b981%22%20fill-opacity%3D%220.03%22%3E%3Ccircle%20cx%3D%2230%22%20cy%3D%2230%22%20r%3D%224%22/%3E%3C/g%3E%3C/svg%3E')] opacity-40"></div>
        <div class="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-emerald-400 via-teal-500 to-emerald-600 rounded-t-3xl">
          <div class="h-full bg-gradient-to-r from-transparent via-white/30 to-transparent animate-shimmer"></div>
        </div>

        <div class="relative z-10">
          <div class="flex items-center gap-4 mb-8">
            <div class="relative">
              <div class="w-16 h-16 bg-gradient-to-br from-emerald-500 via-teal-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-xl transform rotate-3">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <h2 class="text-4xl font-bold bg-gradient-to-r from-gray-900 via-emerald-700 to-teal-700 bg-clip-text text-transparent">
                Таблица выплат
              </h2>
              <div class="h-1 w-24 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full mt-2"></div>
            </div>
          </div>
      ...
      <div class="relative bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/30 rounded-3xl shadow-2xl p-10 mb-8 border border-blue-100/50 overflow-hidden">
        <!-- Фоновые эффекты -->
        <div class="absolute inset-0 bg-blue-50/20" style="background-image: radial-gradient(circle at 1px 1px, rgba(59, 130, 246, 0.1) 1px, transparent 0); background-size: 20px 20px;" ></div>
        <div class="absolute -top-20 -right-20 w-80 h-80 bg-blue-400/10 rounded-full blur-3xl animate-pulse"></div>
        <div class="absolute -bottom-20 -left-20 w-72 h-72 bg-indigo-400/10 rounded-full blur-3xl animate-pulse" style="animation-delay: 3s"></div>
        <div class="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-blue-400 via-indigo-500 to-blue-600 rounded-t-3xl">
          <div class="h-full bg-gradient-to-r from-transparent via-white/30 to-transparent animate-pulse"></div>
        </div>
        ...
        <div class="relative z-10">
          ...
          <div class="flex items-center gap-4 mb-10">
            <div class="relative">
              <div class="w-16 h-16 bg-gradient-to-br from-blue-500 via-indigo-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-xl transform rotate-3 animate-pulse">
                <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="absolute -top-2 -right-2 w-6 h-6 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full flex items-center justify-center animate-bounce">
                <span class="text-white text-xs font-bold">⚙️</span>
              </div>
            </div>
            <div>
              <h2 class="text-4xl font-bold bg-gradient-to-r from-gray-900 via-blue-700 to-indigo-700 bg-clip-text text-transparent">
                Технические характеристики
              </h2>
              <div class="h-1 w-36 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full mt-2"></div>
            </div>
          </div>
          ...
          <div class="mb-10">
            <div class="flex items-center gap-3 mb-6">
              ...
              <h3 class="text-2xl font-bold text-gray-900">Основная информация</h3>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div class="group bg-gradient-to-br from-white/80 via-purple-50/60 to-pink-50/60 backdrop-blur-sm p-6 rounded-3xl border border-purple-200/60 shadow-xl hover:shadow-purple-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-purple-400/5 to-pink-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    ...
                    <h4 class="font-bold text-gray-900 text-lg group-hover:text-purple-700 transition-colors">Провайдер</h4>
                  </div>
                  <p class="text-purple-600 font-semibold text-xl mb-1">Pragmatic Play</p>
                  <p class="text-purple-500 text-sm">Лидер индустрии</p>
                </div>
              </div>

              <div class="group bg-gradient-to-br from-white/80 via-green-50/60 to-emerald-50/60 backdrop-blur-sm p-6 rounded-3xl border border-green-200/60 shadow-xl hover:shadow-green-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-green-400/5 to-emerald-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    ...
                    <h4 class="font-bold text-gray-900 text-lg group-hover:text-green-700 transition-colors">Дата выпуска</h4>
                  </div>
                  <p class="text-green-600 font-semibold text-xl mb-1">13 февраля 2021</p>
                  <p class="text-green-500 text-sm">Популярный релиз</p>
                </div>
              </div>

              <div class="group bg-gradient-to-br from-white/80 via-blue-50/60 to-cyan-50/60 backdrop-blur-sm p-6 rounded-3xl border border-blue-200/60 shadow-xl hover:shadow-blue-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-blue-400/5 to-cyan-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"></path>
                      </svg>
                    </div>
                    <h4 class="font-bold text-gray-900 text-lg group-hover:text-blue-700 transition-colors">Тип игры</h4>
                  </div>
                  <p class="text-blue-600 font-semibold text-xl mb-1">Видеослот</p>
          ...
          <div class="mb-10">
            <div class="flex items-center gap-3 mb-6">
              <span class="text-2xl animate-spin" style="animation-duration: 4s;">⚙️</span>
              <h3 class="text-2xl font-bold text-gray-900">Игровые параметры</h3>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div class="group bg-gradient-to-br from-white/80 via-orange-50/60 to-red-50/60 backdrop-blur-sm p-6 rounded-3xl border border-orange-200/60 shadow-xl hover:shadow-orange-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-orange-400/5 to-red-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center text-white font-bold text-lg shadow-lg group-hover:scale-110 transition-transform duration-300">6×5</div>
                    <h4 class="font-bold text-gray-900 group-hover:text-orange-700 transition-colors">Поле игры</h4>
                  </div>
                  <p class="text-orange-600 font-semibold text-xl mb-1">6 x 5</p>
                  <p class="text-orange-500 text-sm">Расширенное поле</p>
                </div>
              </div>

              <div class="group bg-gradient-to-br from-white/80 via-teal-50/60 to-cyan-50/60 backdrop-blur-sm p-6 rounded-3xl border border-teal-200/60 shadow-xl hover:shadow-teal-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-teal-400/5 to-cyan-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clip-rule="evenodd"></path>
                      </svg>
                    </div>
                    <h4 class="font-bold text-gray-900 group-hover:text-teal-700 transition-colors">Линии выплат</h4>
                  </div>
                  <p class="text-teal-600 font-semibold text-xl mb-1">Scatter Pays</p>
                  <p class="text-teal-500 text-sm">Кластерные выплаты</p>
                </div>
              </div>

              <div class="group bg-gradient-to-br from-white/80 via-indigo-50/60 to-purple-50/60 backdrop-blur-sm p-6 rounded-3xl border border-indigo-200/60 shadow-xl hover:shadow-indigo-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-indigo-400/5 to-purple-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4zM18 9H2v5a2 2 0 002 2h12a2 2 0 002-2V9zM4 13a1 1 0 011-1h1a1 1 0 110 2H5a1 1 0 01-1-1zm5-1a1 1 0 100 2h1a1 1 0 100-2H9z"></path>
                      </svg>
                    </div>
                    <h4 class="font-bold text-gray-900 group-hover:text-indigo-700 transition-colors">Диапазон ставок</h4>
                  </div>
                  <p class="text-indigo-600 font-semibold text-xl mb-1">€0.20 - €100</p>
                  <p class="text-indigo-500 text-sm">Широкий диапазон</p>
                </div>
              </div>

              <div class="group bg-gradient-to-br from-white/80 via-yellow-50/60 to-orange-50/60 backdrop-blur-sm p-6 rounded-3xl border border-yellow-200/60 shadow-xl hover:shadow-yellow-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-yellow-400/5 to-orange-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    <div class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                      </svg>
                    </div>
                    <h4 class="font-bold text-gray-900 group-hover:text-yellow-700 transition-colors">Макс. выигрыш</h4>
                  </div>
                  <p class="text-yellow-600 font-semibold text-xl mb-1">5,000x</p>
          ...
          <div>
            <div class="flex items-center gap-3 mb-6">
              ...
              <h3 class="text-2xl font-bold text-gray-900">Дополнительные возможности</h3>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="group bg-gradient-to-br from-white/80 via-green-50/60 to-emerald-50/60 backdrop-blur-sm p-6 rounded-3xl border border-green-200/60 shadow-xl hover:shadow-green-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-green-400/5 to-emerald-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    ...
                    <h4 class="font-bold text-gray-900 text-lg group-hover:text-green-700 transition-colors">Мобильная версия</h4>
                  </div>
                  <p class="text-green-600 font-semibold text-xl mb-2">✅ Доступна</p>
                  <p class="text-green-500 text-sm">iOS и Android</p>
                </div>
              </div>
              ...
              <div class="group bg-gradient-to-br from-white/80 via-purple-50/60 to-pink-50/60 backdrop-blur-sm p-6 rounded-3xl border border-purple-200/60 shadow-xl hover:shadow-purple-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                ...
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    ...
                    <h4 class="font-bold text-gray-900 text-lg group-hover:text-purple-700 transition-colors">Автоигра</h4>
                  </div>
                  <p class="text-purple-600 font-semibold text-xl mb-2">✅ Поддерживается</p>
                  <p class="text-purple-500 text-sm">До 1000 спинов</p>
                </div>
              </div>

              <div class="group bg-gradient-to-br from-white/80 via-blue-50/60 to-indigo-50/60 backdrop-blur-sm p-6 rounded-3xl border border-blue-200/60 shadow-xl hover:shadow-blue-500/20 hover:scale-105 transition-all duration-500 overflow-hidden relative">
                <div class="absolute inset-0 bg-gradient-to-br from-blue-400/5 to-indigo-400/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div class="relative z-10">
                  <div class="flex items-center gap-3 mb-4">
                    ...
                    <h4 class="font-bold text-gray-900 text-lg group-hover:text-blue-700 transition-colors">Турбо режим</h4>
                  </div>
                  <p class="text-blue-600 font-semibold text-xl mb-2">✅ Быстрая игра</p>
      ...
      <div class="bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 rounded-3xl shadow-2xl p-8 mb-8 border border-blue-100/50">
        <!-- Заголовок с анимацией -->
        <div class="flex items-center gap-4 mb-8">
          <div class="relative">
            <div class="w-14 h-14 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl flex items-center justify-center transform rotate-3 shadow-lg">
          ...
          <div>
            ...
            <p class="text-gray-600 mt-1">Реальные мнения от сообщества слот-игроков</p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
          <!-- Общий рейтинг -->
          <div class="bg-gradient-to-br from-yellow-400 to-orange-500 p-6 rounded-2xl text-white transform hover:scale-105 transition-all duration-300 shadow-xl">
            <div class="flex items-center justify-between mb-3">
              <div class="text-4xl font-black">4.3</div>
              <div class="text-2xl">⭐</div>
            </div>
            <div class="text-yellow-100 text-sm font-medium">Общий рейтинг</div>
            <div class="flex text-yellow-200 text-lg mt-1">★★★★☆</div>
          </div>

          <!-- Количество отзывов -->
          <div class="bg-gradient-to-br from-green-500 to-emerald-600 p-6 rounded-2xl text-white transform hover:scale-105 transition-all duration-300 shadow-xl">
            <div class="flex items-center justify-between mb-3">
              <div class="text-4xl font-black">1.2K+</div>
              <div class="text-2xl">📝</div>
            </div>
            <div class="text-green-100 text-sm font-medium">Всего отзывов</div>
            <div class="text-green-200 text-sm mt-1">активное сообщество</div>
          </div>

          <!-- Положительные отзывы -->
          <div class="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 rounded-2xl text-white transform hover:scale-105 transition-all duration-300 shadow-xl">
            <div class="flex items-center justify-between mb-3">
          ...
          <!-- Рекомендации -->
          <div class="bg-gradient-to-br from-purple-500 to-pink-600 p-6 rounded-2xl text-white transform hover:scale-105 transition-all duration-300 shadow-xl">
            <div class="flex items-center justify-between mb-3">
        ...
        <div class="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-blue-100 shadow-lg">
            ...
            <div class="space-y-4">
              <div class="flex items-center gap-3">
                <span class="text-sm font-semibold text-gray-700 w-8">5★</span>
                <div class="flex-1 bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                  <div class="bg-gradient-to-r from-green-400 to-green-600 h-full rounded-full relative" style="width: 45%;">
              ...
              <div class="flex items-center gap-3">
                <span class="text-sm font-semibold text-gray-700 w-8">4★</span>
                <div class="flex-1 bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                  <div class="bg-gradient-to-r from-blue-400 to-blue-600 h-full rounded-full relative" style="width: 30%;">
                    <div class="absolute inset-0 bg-white/30 animate-pulse"></div>
                  </div>
                </div>
              ...
              <div class="flex items-center gap-3">
                <span class="text-sm font-semibold text-gray-700 w-8">3★</span>
                <div class="flex-1 bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                  <div class="bg-gradient-to-r from-yellow-400 to-yellow-600 h-full rounded-full" style="width: 15%;"></div>
                </div>
                <span class="text-sm font-bold text-yellow-600 w-12">15%</span>
                <span class="text-xs text-gray-500 w-12">187</span>
              </div>
              <div class="flex items-center gap-3">
                <span class="text-sm font-semibold text-gray-700 w-8">2★</span>
                <div class="flex-1 bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                  <div class="bg-gradient-to-r from-orange-400 to-orange-600 h-full rounded-full" style="width: 7%;"></div>
                </div>
                <span class="text-sm font-bold text-orange-600 w-12">7%</span>
                <span class="text-xs text-gray-500 w-12">87</span>
              </div>
              <div class="flex items-center gap-3">
                <span class="text-sm font-semibold text-gray-700 w-8">1★</span>
                <div class="flex-1 bg-gray-200 rounded-full h-3 overflow-hidden shadow-inner">
                  <div class="bg-gradient-to-r from-red-400 to-red-600 h-full rounded-full" style="width: 3%;"></div>
                </div>
          ...
          <!-- Анализ настроений -->
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-green-100 shadow-lg">
            <h3 class="text-xl font-bold text-gray-800 mb-6 flex items-center gap-3">
              <span class="text-2xl">🎭</span>
              Анализ настроений
            </h3>
            <div class="space-y-4">
              <div class="flex items-center gap-3 p-3 bg-green-50 rounded-xl border border-green-200">
                ...
                <div class="flex-1">
                  <div class="font-semibold text-green-800">Потрясающая графика</div>
                  <div class="text-sm text-green-600">Упоминается в 89% позитивных отзывов</div>
                </div>
              </div>
              ...
              <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-xl border border-blue-200">
                ...
                <div class="flex-1">
                  ...
                  <div class="text-sm text-blue-600">Крупные множители в бонусах</div>
                </div>
              </div>
              ...
              <div class="flex items-center gap-3 p-3 bg-purple-50 rounded-xl border border-purple-200">
                ...
                <div class="flex-1">
                  <div class="font-semibold text-purple-800">Стабильная работа</div>
              ...
              <div class="flex items-center gap-3 p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                ...
                <div class="flex-1">
                  <div class="font-semibold text-yellow-800">Высокая волатильность</div>
        ...
        <div class="space-y-6">
          ...
          <!-- Отзыв 1 - Позитивный -->
          <div class="group bg-gradient-to-r from-green-50/80 to-emerald-50/80 backdrop-blur-sm rounded-2xl p-6 border-l-4 border-green-500 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-start gap-4">
              <div class="relative">
                <div class="w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg">
                  А
                </div>
              ...
              <div class="flex-1">
                <div class="flex items-center gap-3 mb-3">
                  <h4 class="font-bold text-gray-800 text-lg">Александр К.</h4>
                  <div class="flex text-yellow-400 text-lg">★★★★★</div>
                  <span class="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs font-semibold">Проверенный игрок</span>
                </div>
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-4 text-sm text-gray-600">
                    <span class="flex items-center gap-1 bg-white/50 px-3 py-1 rounded-full">
                      <svg class="w-4 h-4 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clip-rule="evenodd"></path>
                      </svg>
                      47 лайков
                    </span>
                    <span class="bg-white/50 px-3 py-1 rounded-full">💬 12 ответов</span>
                  </div>
                  <span class="text-sm text-gray-500 bg-white/30 px-3 py-1 rounded-full">2 дня назад</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="group bg-gradient-to-r from-blue-50/80 to-indigo-50/80 backdrop-blur-sm rounded-2xl p-6 border-l-4 border-blue-500 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-start gap-4">
              <div class="relative">
                <div class="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg">
                  М
                </div>
                <div class="absolute -top-1 -right-1 w-6 h-6 bg-blue-400 rounded-full flex items-center justify-center">
              ...
              <div class="flex-1">
                <div class="flex items-center gap-3 mb-3">
                  ...
                  <div class="flex text-yellow-400 text-lg">★★★★☆</div>
                  <span class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-xs font-semibold">Активный игрок</span>
                </div>
                <p class="text-gray-700 mb-4 leading-relaxed">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-4 text-sm text-gray-600">
                    ...
                    <span class="bg-white/50 px-3 py-1 rounded-full">💬 8 ответов</span>
                  </div>
                  <span class="text-sm text-gray-500 bg-white/30 px-3 py-1 rounded-full">1 неделю назад</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="group bg-gradient-to-r from-purple-50/80 to-pink-50/80 backdrop-blur-sm rounded-2xl p-6 border-l-4 border-purple-500 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-start gap-4">
              <div class="relative">
                <div class="w-14 h-14 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg">
                  Д
                </div>
              ...
              <div class="flex-1">
                <div class="flex items-center gap-3 mb-3">
                  ...
                  <div class="flex text-yellow-400 text-lg">★★★★★</div>
                  <span class="bg-gradient-to-r from-yellow-200 to-orange-200 text-orange-800 px-3 py-1 rounded-full text-xs font-semibold">VIP игрок</span>
                </div>
                <p class="text-gray-700 mb-4 leading-relaxed">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-4 text-sm text-gray-600">
                    ...
                    <span class="bg-white/50 px-3 py-1 rounded-full">💬 25 ответов</span>
                    <span class="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-xs">🔥 Топ отзыв</span>
                  </div>
                  <span class="text-sm text-gray-500 bg-white/30 px-3 py-1 rounded-full">3 дня назад</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="mt-8 text-center">
          <button class="group relative bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 hover:scale-105">
            <span class="flex items-center gap-3">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-white/0 via-white/20 to-white/0 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-700 rounded-2xl"></div>
          </button>
        </div>
      </div>

      <!-- Профессиональная оценка - Премиум дизайн -->
      <div class="relative overflow-hidden bg-white rounded-3xl shadow-2xl border border-gray-100 mb-8">
        <!-- Декоративный фон с анимациями -->
        <div class="absolute inset-0 opacity-5">
          <div class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-blue-400 to-purple-600 rounded-full blur-3xl animate-pulse"></div>
          <div class="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-yellow-400 to-orange-500 rounded-full blur-3xl animate-pulse" style="animation-delay: 1s"></div>
        </div>
        ...
        <div class="relative z-10 p-8 lg:p-12">
          ...
          <div class="flex items-center gap-4 mb-10">
            <div class="relative">
              <div class="w-16 h-16 bg-gradient-to-br from-blue-500 via-purple-600 to-indigo-700 rounded-2xl flex items-center justify-center shadow-2xl transform hover:scale-110 transition-transform duration-300">
                <div class="absolute inset-0 bg-gradient-to-br from-blue-400 via-purple-500 to-indigo-600 rounded-2xl animate-pulse opacity-70"></div>
                <svg class="relative w-8 h-8 text-white animate-spin" style="animation-duration: 8s" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M11.49 3.17c-.38-1.56-2.6-1.56-2.98 0a1.532 1.532 0 01-2.286.948c-1.372-.836-2.942.734-2.106 2.106.54.886.061 2.042-.947 2.287-1.561.379-1.561 2.6 0 2.978a1.532 1.532 0 01.947 2.287c-.836 1.372.734 2.942 2.106 2.106a1.532 1.532 0 012.287.947c.379 1.561 2.6 1.561 2.978 0a1.533 1.533 0 012.287-.947c1.372.836 2.942-.734 2.106-2.106a1.533 1.533 0 01.947-2.287c1.561-.379 1.561-2.6 0-2.978a1.532 1.532 0 01-.947-2.287c.836-1.372-.734-2.942-2.106-2.106a1.532 1.532 0 01-2.287-.947zM10 13a3 3 0 100-6 3 3 0 000 6z" clip-rule="evenodd"></path>
                </svg>
              </div>
            </div>
            <div>
              <h2 class="text-4xl lg:text-5xl font-black bg-gradient-to-r from-gray-800 via-blue-700 to-purple-800 bg-clip-text text-transparent mb-2">
                Профессиональная оценка
              </h2>
              <p class="text-gray-600 text-lg font-medium">Детальный анализ от экспертов индустрии 🎯</p>
            </div>
          </div>

          <!-- Общая оценка с впечатляющим дизайном -->
          <div class="relative bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 rounded-3xl p-8 mb-12 border border-yellow-200 shadow-xl">
            <div class="absolute top-4 right-4 text-6xl opacity-10 animate-bounce">⚡</div>
            
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div class="text-center lg:text-left">
                <h3 class="text-2xl lg:text-3xl font-bold text-gray-800 mb-4">Общая экспертная оценка</h3>
              ...
              <div class="text-center">
                <div class="relative inline-block">
                  <div class="w-32 h-32 bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 rounded-full flex items-center justify-center shadow-2xl transform hover:scale-110 transition-transform duration-300">
                    <div class="absolute inset-2 bg-white rounded-full flex items-center justify-center">
                      <span class="text-4xl font-black bg-gradient-to-r from-yellow-600 to-red-600 bg-clip-text text-transparent">8.5</span>
                    </div>
                  </div>
                  <div class="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                    <span class="bg-white px-4 py-1 rounded-full text-sm font-semibold text-gray-600 shadow-lg border">из 10</span>
                  </div>
                </div>
                
                <div class="flex items-center justify-center gap-1 mt-6">
                  <div v-for="n in 5" :key="n" class="text-3xl transition-transform hover:scale-125 duration-300">
                    {{ n <= 4 ? '⭐' : '☆' }}
                  </div>
                </div>
              </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="space-y-6">
              <!-- Графика -->
              <div class="group bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200 hover:shadow-lg transition-all duration-300">
                <div class="flex justify-between items-center mb-4">
                  <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center">
                      <span class="text-xl">🎨</span>
                    </div>
                    <span class="font-bold text-gray-800 text-lg">Графика и анимация</span>
                  </div>
                ...
                <div class="relative w-full bg-blue-200 rounded-full h-3 overflow-hidden">
                  <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full transform origin-left scale-x-90 transition-transform duration-1000 group-hover:scale-x-100"></div>
                  <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent rounded-full animate-pulse"></div>
                </div>
              </div>

              <!-- Геймплей -->
              <div class="group bg-gradient-to-r from-green-50 to-emerald-100 p-6 rounded-2xl border border-green-200 hover:shadow-lg transition-all duration-300">
                <div class="flex justify-between items-center mb-4">
                  <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-700 rounded-xl flex items-center justify-center">
                      <span class="text-xl">🎮</span>
                    </div>
                    <span class="font-bold text-gray-800 text-lg">Геймплей</span>
                  </div>
                  <div class="text-right">
                ...
                <div class="relative w-full bg-green-200 rounded-full h-3 overflow-hidden">
                  <div class="absolute inset-0 bg-gradient-to-r from-green-400 to-emerald-600 rounded-full transform origin-left scale-x-80 transition-transform duration-1000 group-hover:scale-x-90"></div>
                  <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent rounded-full animate-pulse"></div>
                </div>
              </div>

              <!-- Потенциал выигрыша -->
              <div class="group bg-gradient-to-r from-purple-50 to-pink-100 p-6 rounded-2xl border border-purple-200 hover:shadow-lg transition-all duration-300">
                <div class="flex justify-between items-center mb-4">
                  <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-700 rounded-xl flex items-center justify-center">
                      <span class="text-xl">💎</span>
                    </div>
                    <span class="font-bold text-gray-800 text-lg">Потенциал выигрыша</span>
                  </div>
                  <div class="text-right">
                ...
                <div class="relative w-full bg-purple-200 rounded-full h-3 overflow-hidden">
                  <div class="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-600 rounded-full transform origin-left scale-x-90 transition-transform duration-1000 group-hover:scale-x-100"></div>
                  <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent rounded-full animate-pulse"></div>
                </div>
              </div>
            </div>
            ...
            <div class="space-y-6">
              <!-- Бонусы -->
              <div class="group bg-gradient-to-r from-orange-50 to-red-100 p-6 rounded-2xl border border-orange-200 hover:shadow-lg transition-all duration-300">
                <div class="flex justify-between items-center mb-4">
                  <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-700 rounded-xl flex items-center justify-center">
                      <span class="text-xl">🎁</span>
                    </div>
                    <span class="font-bold text-gray-800 text-lg">Бонусные функции</span>
                  </div>
                  <div class="text-right">
                ...
                <div class="relative w-full bg-orange-200 rounded-full h-3 overflow-hidden">
                  <div class="absolute inset-0 bg-gradient-to-r from-orange-400 to-red-600 rounded-full transform origin-left scale-x-80 transition-transform duration-1000 group-hover:scale-x-90"></div>
                  <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent rounded-full animate-pulse"></div>
                </div>
              </div>

              <!-- Мобильная версия -->
              <div class="group bg-gradient-to-r from-teal-50 to-cyan-100 p-6 rounded-2xl border border-teal-200 hover:shadow-lg transition-all duration-300">
                <div class="flex justify-between items-center mb-4">
                  <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-gradient-to-br from-teal-500 to-cyan-700 rounded-xl flex items-center justify-center">
                      <span class="text-xl">📱</span>
                    </div>
                    <span class="font-bold text-gray-800 text-lg">Мобильная версия</span>
                  </div>
                  <div class="text-right">
                    <div class="text-2xl font-black text-teal-600">9.0</div>
                    <div class="text-sm text-gray-500">из 10</div>
                  </div>
                </div>
                <div class="relative w-full bg-teal-200 rounded-full h-3 overflow-hidden">
                  <div class="absolute inset-0 bg-gradient-to-r from-teal-400 to-cyan-600 rounded-full transform origin-left scale-x-90 transition-transform duration-1000 group-hover:scale-x-100"></div>
                  <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent rounded-full animate-pulse"></div>
                </div>
              </div>

              <!-- Частота выплат -->
              <div class="group bg-gradient-to-r from-red-50 to-pink-100 p-6 rounded-2xl border border-red-200 hover:shadow-lg transition-all duration-300">
                <div class="flex justify-between items-center mb-4">
                  <div class="flex items-center gap-3">
                    <div class="w-12 h-12 bg-gradient-to-br from-red-500 to-pink-700 rounded-xl flex items-center justify-center">
                      <span class="text-xl">⏰</span>
                    </div>
                    <span class="font-bold text-gray-800 text-lg">Частота выплат</span>
                  </div>
                  <div class="text-right">
                ...
                <div class="relative w-full bg-red-200 rounded-full h-3 overflow-hidden">
                  <div class="absolute inset-0 bg-gradient-to-r from-red-400 to-pink-600 rounded-full transform origin-left scale-x-70 transition-transform duration-1000 group-hover:scale-x-80"></div>
                  <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/30 to-transparent rounded-full animate-pulse"></div>
                </div>
              </div>
            </div>
          ...
          <div class="relative bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-3xl p-8 mb-10 border-l-8 border-blue-500 shadow-xl">
            <div class="absolute top-6 right-6 text-5xl opacity-20 animate-pulse">💬</div>
            ...
            <div class="flex items-start gap-6 mb-6">
              ...
              <div>
                <h3 class="text-2xl font-bold text-blue-900 mb-2 flex items-center gap-2">
                  ...
                  <div class="px-3 py-1 bg-blue-100 text-blue-800 text-sm font-semibold rounded-full">Сертифицированный эксперт</div>
                </h3>
                <p class="text-gray-600 font-medium">Ведущий аналитик игровой индустрии • 8+ лет опыта</p>
              </div>
            </div>
            
            <blockquote class="text-lg text-blue-900 leading-relaxed font-medium italic border-l-4 border-blue-300 pl-6">
          ...
          <div class="relative bg-gradient-to-r from-yellow-50 via-orange-50 to-red-50 border-2 border-yellow-300 rounded-2xl p-6 mb-10">
            <div class="absolute -top-3 left-6">
              <div class="bg-yellow-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-lg">
                ⚠️ ВАЖНО
              </div>
            </div>
            
            <div class="flex items-start gap-4 mt-2">
              <div class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg animate-pulse">
                <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                </svg>
              </div>
              <div>
                <h4 class="text-xl font-bold text-yellow-800 mb-3">Предупреждение о волатильности</h4>
                <p class="text-yellow-900 leading-relaxed font-medium">
                  ...
                  <span class="font-bold">Рекомендуется иметь достаточный банкролл и играть ответственно.</span> 
                  Устанавливайте лимиты и никогда не играйте деньгами, которые не можете позволить себе потерять. 💰
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <!-- Преимущества -->
            <div class="relative bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-3xl p-8 border-2 border-green-200 shadow-xl">
              <div class="absolute -top-4 left-6">
                <div class="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-2 rounded-full font-bold shadow-lg">
                  ✅ ПРЕИМУЩЕСТВА
                </div>
              </div>
              ...
              <div class="mt-4">
                ...
                <ul class="space-y-4">
                  <li class="flex items-start gap-4 group">
                    <div class="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      <span class="text-white font-bold text-sm">1</span>
                    </div>
                    <div>
                      <div class="font-bold text-green-800 text-lg">Инновационная механика Scatter Pays</div>
                      <div class="text-green-700 text-sm">Революционная система выплат</div>
                    </div>
                  </li>
                  ...
                  <li class="flex items-start gap-4 group">
                    ...
                    <div>
                      <div class="font-bold text-green-800 text-lg">Потенциал выигрыша x5,000</div>
                      <div class="text-green-700 text-sm">Огромные возможности для выигрыша</div>
                    </div>
                  </li>
                  ...
                  <li class="flex items-start gap-4 group">
                    ...
                    <div>
                      <div class="font-bold text-green-800 text-lg">Превосходная графика</div>
                      <div class="text-green-700 text-sm">Визуальное наслаждение на высоком уровне</div>
                    </div>
                  </li>
                  ...
                  <li class="flex items-start gap-4 group">
                    ...
                    <div>
                      <div class="font-bold text-green-800 text-lg">Каскадные выигрыши</div>
                      <div class="text-green-700 text-sm">Множественные выплаты в одном спине</div>
                    </div>
                  </li>
                  ...
                  <li class="flex items-start gap-4 group">
                    ...
                    <div>
                      <div class="font-bold text-green-800 text-lg">Мобильная оптимизация</div>
                      <div class="text-green-700 text-sm">Идеальная работа на всех устройствах</div>
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <!-- Недостатки -->
            <div class="relative bg-gradient-to-br from-red-50 via-pink-50 to-rose-50 rounded-3xl p-8 border-2 border-red-200 shadow-xl">
              <div class="absolute -top-4 left-6">
                <div class="bg-gradient-to-r from-red-500 to-pink-600 text-white px-6 py-2 rounded-full font-bold shadow-lg">
                  ❌ НЕДОСТАТКИ
                </div>
              </div>
              
              <div class="mt-4">
                <div class="w-16 h-16 bg-gradient-to-br from-red-500 to-pink-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg">
                  <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <ul class="space-y-4">
                  <li class="flex items-start gap-4 group">
                    <div class="w-8 h-8 bg-red-500 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                      <span class="text-white font-bold text-sm">1</span>
                    </div>
                    <div>
                      <div class="font-bold text-red-800 text-lg">Высокая волатильность</div>
                      <div class="text-red-700 text-sm">Редкие, но крупные выигрыши</div>
                    </div>
                  </li>
                  ...
                  <li class="flex items-start gap-4 group">
                    ...
                    <div>
                      <div class="font-bold text-red-800 text-lg">Требует большой банкролл</div>
                      <div class="text-red-700 text-sm">Необходим солидный стартовый капитал</div>
                    </div>
                  </li>
                  ...
                  <li class="flex items-start gap-4 group">
                    ...
                    <div>
                      <div class="font-bold text-red-800 text-lg">Не для новичков</div>
                      <div class="text-red-700 text-sm">Сложно для консервативных игроков</div>
                    </div>
                  </li>
                  ...
                  <li class="flex items-start gap-4 group">
                    ...
                    <div>
                      <div class="font-bold text-red-800 text-lg">Редкие бонусы</div>
                      <div class="text-red-700 text-sm">Бонусные раунды активируются нечасто</div>
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-8 text-white shadow-2xl">
            ...
            <div class="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-white/10 to-transparent rounded-full blur-2xl"></div>
            ...
            <div class="relative z-10">
              <div class="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 class="text-3xl font-black mb-2">Итоговая рекомендация</h3>
                  <p class="text-blue-100 font-medium">От экспертов SlotQuest</p>
                </div>
              </div>
              ...
              <div class="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
                <p class="text-lg leading-relaxed text-blue-50 font-medium">
                  <span class="font-bold text-yellow-300">Gates of Olympus</span> - это выдающийся слот для опытных игроков, которые ценят инновационную механику и готовы к высокой волатильности ради потенциала больших выигрышей. 
                  <span class="font-bold text-white">Новичкам рекомендуем начать с менее волатильных слотов.</span> 
                  Этот слот станет идеальным выбором для тех, кто ищет адреналин и готов к серьёзной игре! 🚀
                </p>
              </div>
            </div>
          </div>
      ...
      <!-- Заключение -->
      <div class="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 rounded-3xl shadow-2xl p-8 mb-8 border border-indigo-100">
        <!-- Анимированный фон -->
        <div class="absolute inset-0 opacity-5">
          <div class="absolute top-4 left-8 w-32 h-32 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full blur-xl animate-pulse"></div>
          <div class="absolute bottom-8 right-12 w-24 h-24 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full blur-lg animate-bounce" style="animation-duration: 4s; animation-delay: 1s"></div>
          <div class="absolute top-16 right-4 w-16 h-16 bg-gradient-to-r from-emerald-400 to-teal-500 rounded-full blur-md animate-pulse" style="animation-delay: 2s"></div>
        </div>

        <!-- Заголовок с премиум иконкой -->
        <div class="relative z-10 flex items-center gap-4 mb-8">
          <div class="relative">
            <div class="w-14 h-14 bg-gradient-to-r from-emerald-500 via-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-lg transform hover:scale-105 transition-transform duration-300">
              <div class="absolute inset-0 bg-gradient-to-r from-emerald-400 to-green-500 rounded-2xl blur opacity-40 animate-pulse"></div>
              <svg class="relative z-10 w-7 h-7 text-white" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
              </svg>
            </div>
            <!-- Блик -->
            <div class="absolute -top-1 -right-1 w-3 h-3 bg-white/60 rounded-full animate-ping"></div>
          </div>
          <div>
            <h2 class="text-4xl font-bold bg-gradient-to-r from-slate-800 via-indigo-900 to-purple-800 bg-clip-text text-transparent">
              Заключение
            </h2>
            <div class="h-1 bg-gradient-to-r from-emerald-500 via-blue-500 to-purple-500 rounded-full mt-2 transform scale-x-0 animate-pulse" style="animation: scaleX 2s ease-out 0.5s forwards;"></div>
          </div>
        </div>

        <!-- Главная карточка с итоговой оценкой -->
        <div class="relative z-10 bg-white/80 backdrop-blur-sm rounded-2xl p-8 mb-8 shadow-xl border border-white/50">
          <div class="absolute inset-0 bg-gradient-to-r from-blue-500/5 via-indigo-500/10 to-purple-500/5 rounded-2xl"></div>
          ...
          <div class="relative z-10">
            <div class="flex items-center gap-3 mb-6">
              ...
              <h3 class="text-2xl font-bold bg-gradient-to-r from-slate-700 to-indigo-800 bg-clip-text text-transparent">
            ...
            <div class="space-y-4">
              <p class="text-lg text-slate-700 leading-relaxed font-medium">
                {{ slot.name || 'Этот слот' }} заслуженно считается одним из <span class="text-indigo-600 font-semibold">лучших слотов от Pragmatic Play</span>. 
                Сочетание инновационной механики Scatter Pays, высокого потенциала выигрыша до 
                <span class="text-emerald-600 font-bold">x5,000</span> и превосходной графики делают его обязательным для всех любителей азартных игр.
              </p>
              <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-4 border-l-4 border-indigo-400">
                <p class="text-slate-700 leading-relaxed">
                  Революционная система выплат, где выигрыши начисляются за <span class="font-semibold text-indigo-700">8+ одинаковых символов</span> 
                  в любом месте экрана, открывает новые горизонты в мире видеослотов. Каскадные выигрыши и множители создают 
        ...
        <div class="relative z-10 grid md:grid-cols-2 gap-6 mb-8">
          <div class="group bg-gradient-to-br from-emerald-50 to-green-100 rounded-2xl p-6 border border-emerald-200/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center gap-3 mb-4">
              <div class="w-10 h-10 bg-gradient-to-r from-emerald-500 to-green-500 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                </svg>
              </div>
              <h4 class="text-lg font-bold text-emerald-800">Кому подходит</h4>
            </div>
            <div class="space-y-3">
              ...
              <div class="flex items-center gap-3 text-emerald-700">
                <div class="w-1.5 h-1.5 bg-emerald-500 rounded-full"></div>
                <span class="font-medium">Любителям высокой волатильности</span>
              </div>
              <div class="flex items-center gap-3 text-emerald-700">
                <div class="w-1.5 h-1.5 bg-emerald-500 rounded-full"></div>
          ...
          <div class="group bg-gradient-to-br from-amber-50 to-yellow-100 rounded-2xl p-6 border border-amber-200/50 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div class="flex items-center gap-3 mb-4">
              <div class="w-10 h-10 bg-gradient-to-r from-amber-500 to-yellow-500 rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300">
                <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"></path>
                </svg>
              </div>
        ...
        <div class="relative z-10 bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 rounded-2xl p-8 text-white shadow-2xl overflow-hidden">
          <!-- Анимированный фон для финального блока -->
          <div class="absolute inset-0 opacity-20">
            <div class="absolute top-2 left-4 w-20 h-20 bg-white/30 rounded-full blur-xl animate-pulse"></div>
            <div class="absolute bottom-2 right-8 w-16 h-16 bg-white/20 rounded-full blur-lg animate-bounce" style="animation-duration: 3s"></div>
            <div class="absolute top-8 right-4 w-12 h-12 bg-white/25 rounded-full blur-md animate-pulse" style="animation-delay: 1s"></div>
          </div>
          ...
          <div class="relative z-10">
            ...
            <p class="text-white/90 leading-relaxed text-lg">
              <span class="font-semibold text-white">Gates of Olympus</span> - это не просто слот, это 
              <span class="text-yellow-300 font-semibold">новая эра в мире азартных игр</span>. 
              Если вы готовы к вызову и хотите испытать настоящий адреналин от игры, этот слот создан именно для вас. 
              <span class="text-red-300 font-medium">Помните: играйте ответственно и наслаждайтесь процессом!</span> 🎰✨
            </p>
          </div>
        </div>
          ...
          <div class="text-center mb-12">
            ...
            <div class="space-y-2">
              <p class="text-xl lg:text-2xl text-gray-200 font-medium">
                Окунитесь в легендарный мир <span class="text-yellow-300 font-bold">{{ slot.name || 'этого слота' }}</span>
              </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div class="aspect-video bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center">
              <span class="text-white text-3xl font-bold">{{ (similarSlot.name || 'S').charAt(0) }}</span>
            </div>

            <div class="p-6">
              <h3 class="font-bold text-xl mb-2 text-gray-800">{{ similarSlot.name || 'Слот' }}</h3>
              <p class="text-gray-600 mb-3">{{ similarSlot.provider?.name || 'Провайдер' }}</p>
              <div class="flex justify-between items-center mb-4">
                <span class="text-sm font-medium text-green-600 bg-green-100 px-3 py-1 rounded-full">
                  RTP: {{ similarSlot.rtp ?? '96' }}%
                </span>
                <span class="text-sm text-gray-500 capitalize">{{ similarSlot.volatility || 'средняя' }}</span>
              </div>
  ...
  if (slot.value && !loading.value && !error.value) {
    ...
    useHead({
      ...
      meta: [
        {
          name: 'description',
          content: 'Играйте в слот от ведущего провайдера. Отличные возможности для выигрыша!'
        }
      ]
    })
  }
...
const getSlotDescription = (slot) => {
  if (!slot || !slot.name) return 'Увлекательный видеослот с отличными возможностями для выигрыша.'
  if ((slot.name || '').toLowerCase().includes('gates of olympus')) {
...
const getShortDescription = (slot) => {
  if (!slot || !slot.name) return 'Захватывающий видеослот с отличными возможностями для выигрыша и увлекательным геймплеем.'
  if ((slot.name || '').toLowerCase().includes('gates of olympus')) {
...
const getDetailedDescription = (slot) => {
  if (!slot || !slot.name) return 'Этот увлекательный видеослот предлагает игрокам захватывающий геймплей с множеством возможностей для крупных выигрышей. Современная графика и звуковое сопровождение создают неповторимую атмосферу азарта.'
  if ((slot.name || '').toLowerCase().includes('gates of olympus')) {
