      ...
      <div class="container mx-auto px-4 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center space-x-4">
            ...
            <NuxtLink to="/admin/providers" class="px-4 py-2 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 rounded-lg font-medium transition-all transform hover:scale-105">
              🏢 Провайдеры
            </NuxtLink>
...
// Page meta
useHead({
  title: 'SlotQuest Admin - Панель управления',
  meta: [
