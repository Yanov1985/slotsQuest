...
const regex = /\/\/ Auto-title generation \(for preview and generation\)[\s\S]*?return \`🎰 Play \S+ by \S+ -.*?\n\}/;
...
if(content.match(regex)) {
   ...
   console.log('Successfully updated JS generation templates with Olympus custom strings!');
} else {
