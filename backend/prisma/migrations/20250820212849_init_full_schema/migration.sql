...
-- CreateTable
CREATE TABLE "slot_bonuses" (
    "id" SERIAL NOT NULL,
    "slot_id" TEXT NOT NULL,
    "bonus_id" INTEGER NOT NULL,
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "slot_bonuses_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "slot_mechanics" (
    "id" SERIAL NOT NULL,
    "slot_id" TEXT NOT NULL,
    "mechanic_id" INTEGER NOT NULL,
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "slot_mechanics_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "bonuses_name_key" ON "bonuses"("name");
...
-- CreateIndex
CREATE INDEX "idx_bonuses_is_popular" ON "bonuses"("is_popular");

-- CreateIndex
CREATE INDEX "idx_bonuses_sort_order" ON "bonuses"("sort_order");

-- CreateIndex
CREATE INDEX "idx_slot_bonuses_slot_id" ON "slot_bonuses"("slot_id");

-- CreateIndex
CREATE INDEX "idx_slot_bonuses_bonus_id" ON "slot_bonuses"("bonus_id");

-- CreateIndex
CREATE UNIQUE INDEX "slot_bonuses_slot_id_bonus_id_key" ON "slot_bonuses"("slot_id", "bonus_id");
...
-- CreateIndex
CREATE INDEX "idx_mechanics_type" ON "mechanics"("type");

-- CreateIndex
CREATE INDEX "idx_mechanics_is_active" ON "mechanics"("is_active");

-- CreateIndex
CREATE INDEX "idx_mechanics_is_popular" ON "mechanics"("is_popular");

-- CreateIndex
CREATE INDEX "idx_mechanics_sort_order" ON "mechanics"("sort_order");

-- CreateIndex
CREATE INDEX "idx_slot_mechanics_slot_id" ON "slot_mechanics"("slot_id");

-- CreateIndex
CREATE INDEX "idx_slot_mechanics_mechanic_id" ON "slot_mechanics"("mechanic_id");

-- CreateIndex
CREATE UNIQUE INDEX "slot_mechanics_slot_id_mechanic_id_key" ON "slot_mechanics"("slot_id", "mechanic_id");
...
-- AddForeignKey
ALTER TABLE "slot_bonuses" ADD CONSTRAINT "slot_bonuses_slot_id_fkey" FOREIGN KEY ("slot_id") REFERENCES "slots"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "slot_bonuses" ADD CONSTRAINT "slot_bonuses_bonus_id_fkey" FOREIGN KEY ("bonus_id") REFERENCES "bonuses"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "slot_mechanics" ADD CONSTRAINT "slot_mechanics_slot_id_fkey" FOREIGN KEY ("slot_id") REFERENCES "slots"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "slot_mechanics" ADD CONSTRAINT "slot_mechanics_mechanic_id_fkey" FOREIGN KEY ("mechanic_id") REFERENCES "mechanics"("id") ON DELETE CASCADE ON UPDATE CASCADE;
