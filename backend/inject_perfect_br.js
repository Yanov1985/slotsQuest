...
async function main() {
  ...
  // Perfect pt-BR Data from SEMrush
  const perfectBrData = {
  ...
  console.log('Successfully hydrated PERFECT multi-GEO data for Brazil (pt-BR)!');
}
